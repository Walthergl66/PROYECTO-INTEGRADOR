from dashboard.tabs.alertas import renderizar_alertas
from dashboard.tabs.caracterizacion import renderizar_caracterizacion
...
from dashboard.tabs.temporal import renderizar_temporal
